...
public class CommandAddUser extends HystrixCommand<String> {
    ...
    public CommandAddUser(URI userAdminServiceUri, String myAppTokenId, String adminUserTokenId, String userIdentityJson) {
        ...
        if (userAdminServiceUri == null || myAppTokenId == null || adminUserTokenId == null || userIdentityJson==null ) {
            log.error("CommandAddUser initialized with null-values - will fail - userAdminServiceUri:{}, myAppTokenId:{}, adminUserTokenId:{}, userIdentityJson:{}", userAdminServiceUri, myAppTokenId, adminUserTokenId, userIdentityJson);
        }
    }
    ...
    protected String getFallback() {
        log.warn("CommandAddUser - timeout - uri={}", userAdminServiceUri.toString());
        return null;
    }
