...
public class CommandLogonUserByUserCredentialJersey  extends HystrixCommand<String> {

    private static final Logger log = LoggerFactory.getLogger(CommandLogonUserByUserCredentialJersey.class);
